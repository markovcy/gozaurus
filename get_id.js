...
function put_value_values(name, placeholder) {
    let selector = $(`select[name=${name}]`).val();
...
function parse_disperse_filler (resp) {
    ...
    massivofvalue = undefined
    function_foreach (massivofplaceholders, massivofvalue, resp)
}
...
function function_foreach (massivofplaceholders, massivofvalue, resp) {
